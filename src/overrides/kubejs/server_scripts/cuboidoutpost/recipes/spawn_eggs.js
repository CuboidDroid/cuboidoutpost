...
onEvent('recipes', e => {
    ...
    // milk
    spawn_egg_1_alt("minecraft:cat_spawn_egg", "minecraft:ocelot_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:string", "minecraft:cod")
    spawn_egg("minecraft:wolf_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:cooked_beef", "minecraft:bone")
    spawn_egg("minecraft:fox_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:sweet_berries", "minecraft:chicken")
    spawn_egg("minecraft:llama_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:lead", "kubejs:albumen")
    spawn_egg("minecraft:mooshroom_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:brown_mushroom", "minecraft:red_mushroom")
    spawn_egg("minecraft:polar_bear_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:snow_block", "minecraft:glowstone_dust")
    spawn_egg("minecraft:rabbit_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:carrot", "minecraft:golden_carrot")
    spawn_egg("minecraft:panda_spawn_egg", "minecraft:milk", "minecraft:egg", "kubejs:primordial_gloop", "minecraft:snow_block", "minecraft:coal_block")
