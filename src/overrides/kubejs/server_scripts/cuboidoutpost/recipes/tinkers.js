...
events.listen('recipes', e => {
    ...
    e.custom({"type": "tconstruct:melting","ingredient": {"item": "cuboidmod:carbon_nanotube"},"result": {"fluid": "kubejs:fullerine_fluid","amount": 144},"temperature": 400,"time": 10})
    ...
    e.custom({"type": "tconstruct:melting","ingredient": {"item": "cuboidmod:carbon_nanotube_block"},"result": {"fluid": "kubejs:fullerine_fluid","amount": 1296},"temperature": 400,"time": 90})
    ...
    e.custom({"type": "tconstruct:casting_basin","fluid": {"name": "kubejs:fullerine_fluid","amount": 1296},"result": "cuboidmod:carbon_nanotube_block","cooling_time": 60})
    ...
    e.custom({"type": "tconstruct:casting_table","cast": {"item": "tconstruct:ingot_cast" },"cast_consumed": false,"fluid": {"name": "kubejs:fullerine_fluid","amount": 144},"result": "cuboidmod:carbon_nanotube","cooling_time": 60})
    ...
    e.custom({"type": "tconstruct:casting_table","cast": {"item": "tconstruct:ingot_sand_cast" },"cast_consumed": true,"fluid": {"name": "kubejs:fullerine_fluid","amount": 144},"result": "cuboidmod:carbon_nanotube","cooling_time": 60})
